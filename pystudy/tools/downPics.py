...
def downloadPic(url):
    ...
    for each in pic_url:
        ...
        #  定义变量保存图片的路径
        string = 'D://download//' + word + "//" + str(i) + ".jpg"
        fp = open(string, 'wb')
...
if __name__ == '__main__':  # 主程序
    ...
    urls = [
        'http://image.baidu.com/search/flip?tn=baiduimage&ie=utf-8&word='  + word + '&ct=201326592&v=flip&pn={}'
            .format(str(i)) for i in range(0, 400, 20)]
